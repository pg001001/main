...
sudo cp ~/go/bin/jshunter /usr/local/bin/
...
chmod +x /root/main/subdomain_find.sh /root/main/url_find.sh /root/main/information.sh /root/main/run_screen.sh  /root/main/virustotal_url.sh 
